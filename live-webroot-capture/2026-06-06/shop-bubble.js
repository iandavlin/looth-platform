...
(function () {
  ...
  var SHOP_HOME = 'https://dev.loothtool.com/shop';
  ...
  function injectStyles() {
    ...
    var css =
      ...
      /* search */
      '#looth-shop-ov .ls-search-wrap{padding:12px 18px;border-bottom:1px solid var(--lg-line,#e3ddd0);flex:0 0 auto}' +
  ...
  function open() {
    ...
    setTimeout(function () { if (searchEl) searchEl.focus(); }, 260);
  }
  function close() {
