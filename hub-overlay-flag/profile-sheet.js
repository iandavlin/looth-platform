...
(function () {
  ...
  // pulling DOWN once the body is scrolled to the very top (Buck 2026-06-09: this on every
  // pull-up sheet). `atTop` gates the body case so a normal upward scroll isn't hijacked.
